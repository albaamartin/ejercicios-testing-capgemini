...
public class CursosDesarrolloTest {
  ...
  @Test
  public void testCursosDesarrollo() {
    // Test name: CursosDesarrollo
    ...
    // 5 | assertText | id=part-Podemos | 35
    assertEquals("35", driver.findElement(By.id("part-Podemos")).getText());
  }
}
